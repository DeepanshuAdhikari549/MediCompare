...
export default function Landing() {
  ...
  useEffect(() => {
    // Fetch hospitals to show on the homepage
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* NEW: Display Top Hospitals instead of just a blank page */}
      <section className="relative container mx-auto px-4 py-16">
        <h2 className="section-title text-center mb-12">Top Rated Hospitals & Labs</h2>
        {!isLoading && topHospitals.length > 0 ? (
          ...
          <div className="text-center text-slate-500">Loading top locations...</div>
        )}
      </section>
